...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['10 hours ingest/mo', '720p max resolution', '2 ABR ladders', 'RTMP ingest only'] },
  { name: 'Pro', price: '$79/mo', features: ['500 hours ingest/mo', '4K resolution', '6 ABR ladders', 'SRT + WHIP ingest', 'Analytics dashboard'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited ingest', 'Custom CDN integration', 'Sub-second latency', 'SLA guarantee', 'Dedicated support'] },
];
